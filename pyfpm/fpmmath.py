...
__all__=['translate', 'image_center', 'generate_pupil', 'fpm_reconstructor', 'set_iterator', 'calculate_pupil_radius']
...
def rec_test(input_file,  iterator, cfg=None, debug=False):
    """ FPM reconstructon from pupil images
...
def fpm_reconstructor(input_file=None, iterator=None, na=None, debug=False):
    """ FPM reconstructon from pupil images
